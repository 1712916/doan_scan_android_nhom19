...
public class OcrActivity extends Activity {
    ...
    void saveText(String filename, String content)
    {
        ...
        //tạo file
        File exterSave= Environment.getExternalStoragePublicDirectory("Pictures");
        File directory=new File(exterSave.getAbsolutePath()+"/Ahihi/text");
        directory.mkdirs();
